package com.consulat.sn.etatcivil.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.consulat.sn.etatcivil.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(com.consulat.sn.etatcivil.domain.Authority.class.getName(), jcacheConfiguration);
